...
def generate_pdf():
    # Captura o HTML renderizado da página
    html_content = st._get_page_html()
    ...
    # Converte para base64 para download
    b64 = base64.b64encode(pdf_file.read()).decode()
    href = f'<a href="data:application/pdf;base64,{b64}" download="panorama_mercado.pdf">Download PDF</a>'
    return href
...
st.markdown(generate_pdf(), unsafe_allow_html=True)
